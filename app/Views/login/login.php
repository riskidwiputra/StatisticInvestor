...
<head>
    ...
    <link href="<?= asset('assets_login/css/bootstrap3.min.css') ?>" rel="stylesheet" id="bootstrap-css">
    <script src="https://code.jquery.com/jquery-1.11.1.min.js"></script>
    <link rel="stylesheet" href="https://use.fontawesome.com/releases/v5.6.0/css/all.css" integrity="sha384-aOkxzJ5uQz7WBObEZcHvV5JvRW3TUc2rNPA7pe3AwnsUohiw1Vj2Rgx2KSOkF5+h" crossorigin="anonymous">
    <link rel="stylesheet" type="text/css" href="<?= asset('assets_login/css/login.css') ?>"  />
    
    <title>Login</title>
</head>
<body style="background-color: #383080">
        <div class="container">
                <div style="text-align:center"><img class="mt-2"src="<?= asset('assets_login/img/streamgaming.png') ?>" alt="photo" style="width:40%"></div>
                            ...
                            <form class="needs-validation">
                                ...
                                <div class="input-group form-group">
                                    <div class="input-group-prepend">
                                        ...
                                        <input type="password" class="form-control" placeholder="Password" id="tbSifre" required>
                                    </div>   
                                </div>
                                ...
                                <div class="form-group">
                                    <input type="submit" value="Login" class="btn float-right login_btn text-dark" id="btnGiris">    
                                </div>
                            </form>
                        </div>
                        <div class="card-footer">
                            <div class="d-flex justify-content-center links my-1">
                             <button class="btn login_btn text-dark" role="button" id="btnSifreUnuttum" data-toggle="modal" data-target="#openModalID">
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3 class="modal-title" id="ModalTitle2">Need Your Email</h3>
                                                    ...
                                                    <div class="input-group form-group">
                                                        <div class="input-group-prepend">
                                                            ...
                                                            <div class="input-group-append">
                                                                <span class="input-group-text  text-dark" style="width: 100px;font-size: 15px; font-weight: 500">@gmail.com</span>
                                                            </div>     
                                                        </div>       
                                                    </div>
                                                </div>
                                                <div class="modal-footer">
                                                    <input type="submit" value="Gönder" class="btn login_btn text-dark">
                                                </div>
                                            </form>
                                        </div>
                                    </div>
...
<script>
       ...
       $(function(){
           ...
           $('#particles').particleground({
               ...
               dotColor: '#00ff5b', // noktaların rengi.
               lineColor: '#7161FF', // çizgilerin rengi.
